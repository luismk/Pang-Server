...
namespace GameServer.Cmd
{
    public class CmdUserEquip : Pangya_DB
    {
        ...
        {
            var r = procedure(_db, "pangya.USP_CHAR_USER_EQUIP", new string[] { "@IDUSER" }, new type_SqlDbType[] { type_SqlDbType.Int }, new string[] { m_uid.ToString() }, ParameterDirection.Input);
