...
namespace PangyaAPI.IFF.Models
{
    ...
    public class CadieMagicBox 
    {
        ...
        public string Name { get => Encoding.GetEncoding("Shift_JIS").GetString(NameInBytes); set => NameInBytes = Encoding.GetEncoding("Shift_JIS").GetBytes(value.PadRight(40, '\0')); }
