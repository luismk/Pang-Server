...
using PangyaAPI.ZIP.Zlib;
using System.IO;


namespace PangyaAPI.ZIP.Zlib
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        PangyaAPI.ZIP.Zlib.CompressionLevel compressLevel,
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="PangyaAPI.ZIP.Zlib.DeflateStream"/>, except
    ...
    ///
    /// </remarks>
    /// <seealso cref="PangyaAPI.ZIP.Zlib.DeflateStream" />
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private int                         _Crc32;
        private PangyaAPI.ZIP.Crc.CRC32             _runningCrc;
        ...
        private PangyaAPI.ZIP.Zlib.CompressionLevel _compressLevel;
        ...
        ///
        /// <para>
        ///   This class is similar to <see cref="PangyaAPI.ZIP.Zlib.DeflateStream"/>,
        ...
        ///   cref="PangyaAPI.ZIP.Zlib.DeflateStream"/>.  On the other hand, using a
        ...
        private void _InitializePoolOfWorkItems()
        {
            ...
            _runningCrc = new PangyaAPI.ZIP.Crc.CRC32();
            _currentlyFilling = -1;
            _lastFilled = -1;
            _lastWritten = -1;
            _latestCompressed = -1;
        ...
        ///
        /// <para>
        ///   To decompress data, use the <see cref="PangyaAPI.ZIP.Zlib.DeflateStream"/> class.
        /// </para>
        ///
        /// </remarks>
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    PangyaAPI.ZIP.Zlib.CRC32 c= new PangyaAPI.ZIP.Zlib.CRC32();
                    do
                    {
        ...
        private void _DeflateOne(Object wi)
        {
            ...
            try
            {
                ...
                PangyaAPI.ZIP.Crc.CRC32 crc = new PangyaAPI.ZIP.Crc.CRC32();
