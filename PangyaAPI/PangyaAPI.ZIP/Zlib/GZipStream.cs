...
namespace PangyaAPI.ZIP.Zlib
{
    ...
    ///   <c>PangyaAPI.ZIP.Zlib.GZipStream</c> can compress while writing, or decompress while
    ...
    public class GZipStream : System.IO.Stream
    {
        ...
        ///     {
        ///         using (Stream decompressor= new PangyaAPI.ZIP.Zlib.GZipStream(input, CompressionMode.Decompress, true))
        ///         {
        ...
        ///         Using decompressor As Stream = new PangyaAPI.ZIP.Zlib.GZipStream(input, CompressionMode.Decompress, True)
        ...
        public override long Position
        {
            get
            {
                if (this._baseStream._streamMode == PangyaAPI.ZIP.Zlib.ZlibBaseStream.StreamMode.Writer)
                    return this._baseStream._z.TotalBytesOut + _headerByteCount;
                if (this._baseStream._streamMode == PangyaAPI.ZIP.Zlib.ZlibBaseStream.StreamMode.Reader)
        ...
        {
            if (_disposed) throw new ObjectDisposedException("GZipStream");
            if (_baseStream._streamMode == PangyaAPI.ZIP.Zlib.ZlibBaseStream.StreamMode.Undefined)
            {
        ...
        internal static readonly System.Text.Encoding iso8859dash1 = new PangyaAPI.Encoding.Iso8859Dash1Encoding();
#else
