...
namespace PangyaAPI.ZIP.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="PangyaAPI.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="PangyaAPI.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new PangyaAPI.BZip2.ParallelBZip2OutputStream(output))
        ///           {
