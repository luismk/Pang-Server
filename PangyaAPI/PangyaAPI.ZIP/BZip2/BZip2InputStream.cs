...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:PangyaAPI.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace PangyaAPI.ZIP.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly PangyaAPI.ZIP.Crc.CRC32 crc = new PangyaAPI.ZIP.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new PangyaAPI.BZip2.BZip2InputStream(fs))
        ///       {
