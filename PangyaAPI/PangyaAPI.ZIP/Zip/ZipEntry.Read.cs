...
namespace PangyaAPI.ZIP
{
    public partial class ZipEntry
    {
        ...
        private static bool ReadHeader(ZipEntry ze, System.Text.Encoding defaultEncoding)
        {
            ...
            int signature = PangyaAPI.ZIP.SharedUtilities.ReadEntrySignature(ze.ArchiveStream);
            bytesRead += 4;
            ...
            if (ZipEntry.IsNotValidSig(signature))
            {
                ...
                // workitem 10178
                PangyaAPI.ZIP.SharedUtilities.Workaround_Ladybug318918(ze.ArchiveStream);
            ...
            ze._LastModified = PangyaAPI.ZIP.SharedUtilities.PackedToDateTime(ze._TimeBlob);
            ...
            if (!ze._FileNameInArchive.EndsWith("/") && (ze._BitField & 0x0008) == 0x0008)
            {
                ...
                while (wantMore)
                {
                    ...
                    long d = PangyaAPI.ZIP.SharedUtilities.FindSignature(ze.ArchiveStream, ZipConstants.ZipEntryDataDescriptorSignature);
                    if (d == -1) return false;
        ...
        internal static void HandlePK00Prefix(Stream s)
        {
            ...
            uint datum = (uint)PangyaAPI.ZIP.SharedUtilities.ReadInt(s);
        ...
        private static void HandleUnexpectedDataDescriptor(ZipEntry entry)
        {
            ...
            {
                int sz = PangyaAPI.ZIP.SharedUtilities.ReadInt(s);
                if (sz == entry._CompressedSize)
                {
                    sz = PangyaAPI.ZIP.SharedUtilities.ReadInt(s);
