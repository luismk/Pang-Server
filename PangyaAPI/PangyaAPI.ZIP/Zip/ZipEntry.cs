...
namespace PangyaAPI.ZIP
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = PangyaAPI.ZIP.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = PangyaAPI.ZIP.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)PangyaAPI.ZIP.CompressionMethod.None)
                    _CompressionLevel = PangyaAPI.ZIP.Zlib.CompressionLevel.None;
                else if (CompressionLevel == PangyaAPI.ZIP.Zlib.CompressionLevel.None)
                    _CompressionLevel = PangyaAPI.ZIP.Zlib.CompressionLevel.Default;
        ...
        public PangyaAPI.ZIP.Zlib.CompressionLevel CompressionLevel
        {
            ...
            set
            {
                ...
                if (value == PangyaAPI.ZIP.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == PangyaAPI.ZIP.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == PangyaAPI.ZIP.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) PangyaAPI.ZIP.CompressionMethod.None;
                else
                    _CompressionMethod = (short) PangyaAPI.ZIP.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.CompressedSize"/>
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.Encryption"/>
        ...
        ///
        /// </remarks>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.ZipErrorAction"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = PangyaAPI.ZIP.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new PangyaAPI.ZIP.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new PangyaAPI.ZIP.ZipException("The filename must be non-null and non-empty.");
...
#if NETCF
                    // workitem 6878
                    // PangyaAPI.ZIP.SharedUtilities.AdjustTime_Win32ToDotNet
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                PangyaAPI.ZIP.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private PangyaAPI.ZIP.Zlib.CompressionLevel _CompressionLevel;
