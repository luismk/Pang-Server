...
namespace PangyaAPI.ZIP
{
    public partial class ZipFile
    {
        ...
        /// </remarks>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddFile(string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateItem(string)"/>
        ///
        ...
        /// </param>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddFile(string, string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateItem(string, string)"/>
        ///
        /// <example>
        ...
        /// <overloads>This method has two overloads.</overloads>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddItem(string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddDirectory(string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateFile(string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddItem(string,string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddDirectory(string, string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateFile(string,string)"/>
        ///
        /// <param name="fileName">
        ...
        /// </param>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.SelectEntries(String)" />
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddSelectedFiles(String, String)" />
        ...
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddFile(string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateDirectory(string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateItem(string)"/>
        ///
        /// <param name="fileName">
        ...
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddFile(string,string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateDirectory(string,string)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateItem(string,string)"/>
        ///
        /// <param name="fileName">
        ///   The name of the file to add or update. It should refer to a file in the
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.UpdateEntry(string, System.IO.Stream)"/>
        ///
        /// <param name="entryName">
        ...
        /// </remarks>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddEntry(string, System.IO.Stream)"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.InputStream"/>
        ///
        /// <param name="entryName">
        ///   The name, including any path, to use within the archive for the entry.
        /// </param>
        ...
        public void UpdateEntry(string entryName, ZipEntry _update)
        {
            RemoveEntryForUpdate(entryName);
            InternalAddEntry(entryName, _update);
        }
