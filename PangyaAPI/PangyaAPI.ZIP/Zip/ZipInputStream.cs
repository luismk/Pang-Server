...
// reading zip files.  This class does not depend on PangyaAPI.ZIP.ZipFile, but rather
    ...
    public class ZipInputStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                PangyaAPI.ZIP.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private PangyaAPI.ZIP.Crc.CrcCalculatorStream _crcStream;
