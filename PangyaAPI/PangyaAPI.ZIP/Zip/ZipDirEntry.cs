...
namespace PangyaAPI.ZIP
{
    ...
    partial class ZipEntry
    {
            ...
            get
            {
                ...
                if (this._RelativeOffsetOfLocalHeader > 0xFFFFFFFF)
                    ...
                    .Append(string.Format("          Timeblob: 0x{0:X8}\n", this._TimeBlob))
                        .Append(string.Format("              Time: {0}\n", PangyaAPI.ZIP.SharedUtilities.PackedToDateTime(this._TimeBlob)));
                                              ...
                                              Dictionary<String,Object> previouslySeen)
        {
            ...
            int signature = PangyaAPI.ZIP.SharedUtilities.ReadSignature(s);
            ...
            unchecked
            {
                ...
                zde._LastModified = PangyaAPI.ZIP.SharedUtilities.PackedToDateTime(zde._TimeBlob);
            ...
            {
                // UTF-8 is in use
                zde._FileNameInArchive = PangyaAPI.ZIP.SharedUtilities.Utf8StringFromBuffer(block);
            }
            else
            {
                zde._FileNameInArchive = PangyaAPI.ZIP.SharedUtilities.StringFromBuffer(block, expectedEncoding);
            }
            ...
            if (zde._commentLength > 0)
            {
                ...
                {
                    // UTF-8 is in use
                    zde._Comment = PangyaAPI.ZIP.SharedUtilities.Utf8StringFromBuffer(block);
                }
                else
                {
                    zde._Comment = PangyaAPI.ZIP.SharedUtilities.StringFromBuffer(block, expectedEncoding);
                }
            }
