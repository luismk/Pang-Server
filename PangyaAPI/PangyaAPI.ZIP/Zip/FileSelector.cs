...
namespace PangyaAPI.ZIP
{
    ...
    ///   cref="PangyaAPI.ZIP.ZipFile.AddSelectedFiles(String,String)"/> method, or one of
    ///   its overloads, is called.  It's also used for the <see
    ///   cref="PangyaAPI.ZIP.ZipFile.ExtractSelectedEntries(String)"/> methods.  Typically, an
