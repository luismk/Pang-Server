...
// generating zip files.  This class does not depend on PangyaAPI.ZIP.ZipFile, but rather
...
namespace PangyaAPI.ZIP
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = PangyaAPI.ZIP.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="PangyaAPI.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = PangyaAPI.ZIP.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="PangyaAPI.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private PangyaAPI.ZIP.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public PangyaAPI.ZIP.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
