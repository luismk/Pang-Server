...
namespace PangyaAPI.ZIP
{
    public partial class ZipEntry
    {
...
#if BZIP
            if (this.CompressionMethod == PangyaAPI.ZIP.CompressionMethod.BZip2)
        ...
        private bool WantReadAgain()
        {
            ...
            if (CompressionLevel == PangyaAPI.ZIP.Zlib.CompressionLevel.None) return false;
        ...
        private void MaybeUnsetCompressionMethodForWriting(int cycle)
        {
            ...
            if (CompressionLevel == (short)PangyaAPI.ZIP.Zlib.CompressionLevel.None &&
                CompressionMethod == PangyaAPI.ZIP.CompressionMethod.Deflate)
                _CompressionMethod = 0x00;
        ...
        internal void WriteHeader(Stream s, int cycle)
        {
            ...
            // LastMod
            _TimeBlob = PangyaAPI.ZIP.SharedUtilities.DateTimeToPacked(LastModified);
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                {
                    var output = new PangyaAPI.ZIP.Crc.CrcCalculatorStream(Stream.Null);
        ...
        private void _WriteEntryData(Stream s)
        {
            ...
            try
            {
                ...
                var output = new PangyaAPI.ZIP.Crc.CrcCalculatorStream(compressor, true);
        ...
        internal void FinishOutputStream(Stream s,
                                         ...
                                         Stream encryptor,
                                         Stream compressor,
                                         PangyaAPI.ZIP.Crc.CrcCalculatorStream output)
        {
            ...
            if ((compressor as PangyaAPI.ZIP.Zlib.DeflateStream) != null)
                compressor.Close();
#if BZIP
            else if ((compressor as PangyaAPI.BZip2.BZip2OutputStream) != null)
                compressor.Close();
#if !NETCF
            else if ((compressor as PangyaAPI.BZip2.ParallelBZip2OutputStream) != null)
                compressor.Close();
#endif
#endif

#if !NETCF
            else if ((compressor as PangyaAPI.ZIP.Zlib.ParallelDeflateOutputStream) != null)
                compressor.Close();
#endif
            ...
            if (_UncompressedSize == 0 && _CompressedSize == 0)
            {
                ...
                if (_Password != null)
                {
                    ...
                    if (Encryption != EncryptionAlgorithm.None)
                    {
                        ...
                        // workitem 10178
                        PangyaAPI.ZIP.SharedUtilities.Workaround_Ladybug318918(s);
        ...
        internal void PrepOutputStream(Stream s,
                                       ...
                                       out PangyaAPI.ZIP.Crc.CrcCalculatorStream output)
        {
            ...
            // Wrap a CrcCalculatorStream around that.
            // This will happen BEFORE compression (if any) as we write data out.
            output = new PangyaAPI.ZIP.Crc.CrcCalculatorStream(compressor, true);
        }
        ...
        {
            if (_CompressionMethod == 0x08 && CompressionLevel != PangyaAPI.ZIP.Zlib.CompressionLevel.None)
            {
#if !NETCF
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    if (_container.ParallelDeflater == null)
                    {
                        _container.ParallelDeflater =
                            new PangyaAPI.ZIP.Zlib.ParallelDeflateOutputStream(s,
                                                                       CompressionLevel,
                                                                       _container.Strategy,
                                                                       true);
                    ...
                    PangyaAPI.ZIP.Zlib.ParallelDeflateOutputStream o1 = _container.ParallelDeflater;
                    o1.Reset(s);
                    return o1;
                }
#endif
                var o = new PangyaAPI.ZIP.Zlib.DeflateStream(s, PangyaAPI.ZIP.Zlib.CompressionMode.Compress,
                                                     CompressionLevel,
                                                     true);
                if (_container.CodecBufferSize > 0)
            ...
            if (_CompressionMethod == 0x0c)
            {
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    var o1 = new PangyaAPI.BZip2.ParallelBZip2OutputStream(s, true);
                    return o1;
                }
#endif
                var o = new PangyaAPI.BZip2.BZip2OutputStream(s, true);
                return o;
            }
#endif
