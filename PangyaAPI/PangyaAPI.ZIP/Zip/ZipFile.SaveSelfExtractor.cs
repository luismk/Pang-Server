...
namespace PangyaAPI.ZIP
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public PangyaAPI.ZIP.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "PangyaAPI.ZIP.WinFormsSelfExtractorStub.resources",
                    "PangyaAPI.ZIP.Forms.PasswordDialog.resources",
                    "PangyaAPI.ZIP.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace PangyaAPI.ZIP { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the PangyaAPI.ZIP assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider
                    ...
                    // This is the list of referenced assemblies.  PangyaAPI.ZIP is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("PangyaAPI.ZIP.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the PangyaAPI.ZIP
                        ...
                        // add the PangyaAPI.Utils.Zip DLL as an embedded resource
