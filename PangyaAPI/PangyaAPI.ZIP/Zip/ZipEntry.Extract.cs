...
namespace PangyaAPI.ZIP
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="PangyaAPI.ZIP.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="PangyaAPI.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="PangyaAPI.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        ///   using (PangyaAPI.Zlib.CrcCalculatorStream s = e1.OpenReader())
        ///   {
        ...
        ///       Using s As PangyaAPI.Zlib.CrcCalculatorStream = e1.OpenReader
        ///           Dim n As Integer
        ...
        /// </code>
        /// </example>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public PangyaAPI.ZIP.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public PangyaAPI.ZIP.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal PangyaAPI.ZIP.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new PangyaAPI.ZIP.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        internal void CalcWinZipAesMac(Stream input)
        {
                ...
                Encryption == EncryptionAlgorithm.WinZipAes256)
            {
                ...
                else if (input is PangyaAPI.Zlib.CrcCalculatorStream)
                {
                    xxx;
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                PangyaAPI.ZIP.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new PangyaAPI.ZIP.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new PangyaAPI.ZIP.Zlib.DeflateStream(input2, PangyaAPI.ZIP.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new PangyaAPI.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = PangyaAPI.ZIP.SharedUtilities.AdjustTime_Reverse(LastModified);
