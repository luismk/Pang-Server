...
namespace PangyaAPI.ZIP
{
    ...
    ///   DotNetZip in the classes in the PangyaAPI.Zlib namespace.
    /// </para>
    ///
    /// <para>
    ...
    IDisposable
    {
        ...
        ///   information see <see
        ///   cref="PangyaAPI.Zlib.CompressionStrategy">PangyaAPI.Zlib.CompressionStrategy</see>.
        /// </remarks>
        public PangyaAPI.ZIP.Zlib.CompressionStrategy Strategy
        {
        ...
        ///  </para>
        /// </remarks>
        public PangyaAPI.ZIP.Zlib.CompressionLevel CompressionLevel
        {
            get;
            set;
        }
        ...
        ///   </para>
        /// </remarks>
        /// <seealso cref="PangyaAPI.ZIP.CompressionMethod" />
        public PangyaAPI.ZIP.CompressionMethod CompressionMethod
        {
            get
            {
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = PangyaAPI.ZIP.ZipFile.DefaultEncoding;
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.DefaultEncoding">DefaultEncoding</seealso>
        ...
        /// known as IBM437.
        /// </summary>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.ProvisionalAlternateEncoding"/>
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.Encryption">ZipFile.Encryption</seealso>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.Password">ZipEntry.Password</seealso>
        ...
        /// </para>
        /// </remarks>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ExtractExistingFile"/>
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.ZipErrorAction"/>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.ZipError"/>
        ...
        /// </example>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.Password">ZipFile.Password</seealso>
        /// <seealso cref="PangyaAPI.ZIP.ZipEntry.Encryption">ZipEntry.Encryption</seealso>
        ...
        ///   <c>PangyaAPI.Zlib.CompressionLevel.None</c> means no compression will be used.
        /// </para>
        ///
        /// <para>
        ...
        ///     cref="PangyaAPI.Zlib.CompressionLevel.BestSpeed"/>.  You may have to
        ...
        /// </remarks>
        ///
        /// <exception cref="PangyaAPI.ZIP.ZipException">
        ...
        private void _InitInstance(string zipFileName, TextWriter statusMessageWriter)
        {
            ...
            CompressionLevel = PangyaAPI.ZIP.Zlib.CompressionLevel.Default;
#if !NETCF
        ...
        /// </code>
        /// </example>
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.RemoveEntry(string)"/>
        ///
        ...
        /// </remarks>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.this[string]"/>
        ///
        /// <example>
        ...
        /// </param>
        ///
        /// <seealso cref="PangyaAPI.ZIP.ZipFile.RemoveSelectedEntries(string)"/>
        ///
        ...
        internal Stream ReadStream
        {
            get
            {
                if (_readstream == null)
                {
                    ...
                    {
                        //var memory = File.Open(_readName ?? _name,
                        //                        FileMode.Open,
                        //                        FileAccess.Read,
                        //                        FileShare.Read | FileShare.Write);
                        _readstream = new MemoryStream(File.ReadAllBytes(_readName ?? _name));
        ...
        private PangyaAPI.ZIP.Zlib.CompressionStrategy _Strategy = PangyaAPI.ZIP.Zlib.CompressionStrategy.Default;
        private PangyaAPI.ZIP.CompressionMethod _compressionMethod = PangyaAPI.ZIP.CompressionMethod.Deflate;
...
#if !NETCF
        internal PangyaAPI.ZIP.Zlib.ParallelDeflateOutputStream ParallelDeflater;
