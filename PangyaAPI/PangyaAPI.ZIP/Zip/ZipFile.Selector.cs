...
namespace PangyaAPI.ZIP
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            PangyaAPI.ZIP.FileSelector ff = new PangyaAPI.ZIP.FileSelector(selectionCriteria,
...
namespace PangyaAPI.ZIP
{
    ...
    {
        internal abstract bool Evaluate(PangyaAPI.ZIP.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(PangyaAPI.ZIP.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(ZIP.ZipEntry entry)
        {
        ...
        public ICollection<PangyaAPI.ZIP.ZipEntry> SelectEntries(PangyaAPI.ZIP.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<PangyaAPI.ZIP.ZipEntry>();

            foreach (PangyaAPI.ZIP.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<PangyaAPI.ZIP.ZipEntry> SelectEntries(PangyaAPI.ZIP.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
