...
namespace PangyaAPI.ZIP
{
    ...
    public enum ZipEntrySource
    {
        ...
        /// <summary>
        /// The entry was instantiated via <see cref="PangyaAPI.ZIP.ZipFile.AddEntry(string,string)"/> or
        /// <see cref="PangyaAPI.ZIP.ZipFile.AddEntry(string,System.IO.Stream)"/> .
        /// </summary>
        Stream,
        ...
        /// The entry was instantiated via <see cref="PangyaAPI.ZIP.ZipFile.AddEntry(string,OpenDelegate,CloseDelegate)"/>.
        /// </summary>
        JitStream,
