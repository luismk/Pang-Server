...
namespace PangyaAPI.ZIP
{
    ...
    ///   cref="PangyaAPI.ZIP.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="PangyaAPI.ZIP.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="PangyaAPI.ZIP.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="PangyaAPI.ZIP.ZipFile.SetCompression"/>
    public delegate PangyaAPI.ZIP.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
