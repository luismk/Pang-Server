...
namespace PangyaAPI.ZIP
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="PangyaAPI.ZIP.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new PangyaAPI.ZIP.ZipFile())
        /// {
        ///     zip.CompressionLevel= PangyaAPI.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = PangyaAPI.ZIP.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = PangyaAPI.ZIP.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
